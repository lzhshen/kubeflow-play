# Google project 
export PROJECT_ID=kubeflow-test-220404
export K8S_CLUSTER=kubeflow-01
export ZONE=us-central1-a
export USER=29585543@qq.com
export SERVICE_ACCOUNT=kubeflow-codelab
export BUCKET_NAME=kubeflow-bucket-lzhshen
